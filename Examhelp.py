...
left_path = os.path.dirname(os.path.realpath('leftarrow.png')) + '\Downloads\Examhelp\\leftarrow.png'
right_path = os.path.dirname(os.path.realpath('rightarrow.png')) + '\Downloads\Examhelp\\rightarrow.png'
flip_path = os.path.dirname(os.path.realpath('flipimg.png')) + '\Downloads\Examhelp\\flipimg.png'
flash_path = os.path.dirname(os.path.realpath('flash.png')) + '\Downloads\Examhelp\\flash.png'
print(left_path)
